...
void write_sp_info(FILE *fp, int nprocs, char class) 
{
  ...
  else if (class == 'B') { problem_size = 102; dt = "0.001d0";   niter = 4000; }
...
void write_bt_info(FILE *fp, int nprocs, char class, int io) 
{
  ...
  else if (class == 'A') { problem_size = 64;  dt = "0.0008d0";   niter = 300; }
...
void write_mg_info(FILE *fp, int nprocs, char class) 
{
  ...
  else if (class == 'A') { problem_size = 256;  nit = 4000; }
  else if (class == 'B') { problem_size = 256;  nit = 2000/*2350*/; }
  else if (class == 'C') { problem_size = 512;  nit = /*20*/400; }
...
void write_cg_info(FILE *fp, int nprocs, char class) 
{
  ...
  { na=14000;   nonzer=11; niter=950/*1500*/;  shift=shiftA; }
  else if( class == 'B' )
...
void write_ft_info(FILE *fp, int nprocs, char class) 
{
  ...
  else if (class == 'A') { nx = 256;  ny = 256;  nz = 128;  niter = 1000;}
  else if (class == 'B') { nx = 512;  ny = 256;  nz = 256;  niter =200;}
  else if (class == 'C') { nx = 512;  ny = 512;  nz = 512;  niter =200;}
