...
class CkIndex_Jacobi:public CProxyElement_ArrayElement{
  public:
    ...
    static int ckNew(void) { return idx_Jacobi_void(); }
    ...
    inline static int idx_begin_iteration(void (Jacobi::*)(void) ) {
...
/* ---------------- section proxy -------------- */
 class CProxySection_Jacobi : public CProxySection_ArrayElement{
  public:
    ...
    CProxySection_Jacobi(const CkArrayID &aid, CkArrayIndex *elems, int nElems) 
