...
class InitRefineMsg: public CMessage_InitRefineMsg{
    ...
    public:
        ...
        int meshGenIterations, iterations, phase2_it;
        ...
        InitRefineMsg(bool isInMeshGenerationPhase, double dx, double dy, double myt, double mydt, double xmin, double ymin, 
                        int meshGenIterations, int iterations, int phase2_it, vector<double>& refined_u, bool *nbr_exists, bool *nbr_isRefined, DECISION *nbr_decision);
};
